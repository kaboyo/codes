...
rule rawFastqc:
    ...
    input:
        ...
        output: 
            forwardpaired="trimmedReads/{ids}_R1_trimmed.fastq",
            reversepaired="trimmedReads/{ids}_R2_trimmed.fastq",
            ...
            threads: 
                ...
                shell: 
                """
                trimmomatic PE -threads {threads} {input.read1} {input.read2} o {output.trimmed_fq1} {output.unpaired_fq1} {output.trimmed_fq2} {output.unpaired_fq2} ILLUMINACLIP:/path/to/adapters/TruSeq3-PE-2.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:36
                """
    rule cutadapter:
        input:
